...
tour.addStep({
    id: "step1",
    title: " 🌱 gotSeed: Bring a life in your lives! ",
    text: "gotSeed is a web application which lets you to explore a diverse range of plants available at nearby nurseries and gardens 🌿. You can buy it, or reasearch about it. That's it?? Naah, explore the app to learn more! 🪴",
    buttons: [
        {
          text: "Next",
          action() {
